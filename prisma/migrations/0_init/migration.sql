...
CREATE TABLE "operations_staff" (
    ...
    CONSTRAINT "operations_staff_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "operations_staff" ADD CONSTRAINT "operations_staff_dashboard_id_fkey" FOREIGN KEY ("dashboard_id") REFERENCES "operations_dashboard"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
