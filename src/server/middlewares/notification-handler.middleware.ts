...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': {
    roles: ['business-owner', 'operations-manager', 'operations-staff', 'customer-service-representative'],
    key: 'order_id',
    tenantPath: [],
    userPath: [],
  },
  'low_inventory.update': {
    roles: ['business-owner', 'operations-manager', 'operations-staff'],
    key: 'product_id',
    tenantPath: [],
    userPath: [],
  },
  'support_ticket_created.create': {
    roles: ['business-owner', 'operations-manager', 'customer-service-representative'],
    key: 'ticket_id',
    tenantPath: [],
    userPath: [],
  },
